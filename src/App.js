...
// 合约地址
const MYNFT_ADDRESS = "0x4C4145aE3E008752Cfd37aCAF1c4dc0da23a9e0a";
const MARKET_ADDRESS = "0xb9D4f3000B3c1F46Bf630fa4a7Afd74F80023314";
            ...
            {nftsForSale.length === 0 ? (
              ...
              <ul>
                {nftsForSale.map(({ tokenId, price }) => (
                  <li key={tokenId.toString()} className="listItem">
